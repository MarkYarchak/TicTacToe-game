...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppGameBoardCellCellComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CellComponent_img_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    CellComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 2,
      consts: [[1, "board-cell"], ["src", "/assets/cross.svg", "alt", "", 4, "ngIf"], ["class", "cell-empty-circle", 4, "ngIf"], ["src", "/assets/cross.svg", "alt", ""], [1, "cell-empty-circle"]],
